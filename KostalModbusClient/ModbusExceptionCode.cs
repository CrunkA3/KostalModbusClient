public enum ModbusExceptionCode
{
    ...
    /// because it is un-configured and is being asked to return register
    /// values.
    /// </summary>
    ...
    /// <summary>
    /// TA value contained in the query data field is not an allowable value for server.
